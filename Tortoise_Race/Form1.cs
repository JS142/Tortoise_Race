...
private void TransparentBackground()
        ...
        private void GuyRadioButtons()
        {
            ...
            myGuy[1].MyRadioButton.Text = "Joban";
        ...
        private void LBLs()
        {
            ...
            myProperty.LBLJoban = myProperty.NotBetYet;
        ...
        private void GuyNotBetYet()
        {
            ...
            lblSam.Text = myGuy[1].GuyName + myProperty.LBLJoban;
...
private void IsWinner()
            ...
            for (myProperty.Guy = 0; myProperty.Guy < 3; myProperty.Guy++)
            {
                ...
                else
                {
                    ...
                    if (myGuy[myProperty.Guy].MaxCash == 0)
                    {
                        ...
                        {
                            myProperty.LBLJoban = myProperty.Busted;
                            lblSam.Text = myGuy[1].GuyName + myProperty.LBLJoban;
        ...
        {
            if (myProperty.LBLJong == " you have run out of Cash! BUSTED!" && myProperty.LBLJoban == " you have run out of Cash! BUSTED!" && myProperty.LBLJosh == " you have run out of Cash! BUSTED!")
            {
